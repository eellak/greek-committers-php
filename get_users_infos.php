...
if(!is_dir(USERPATH)) {  // CHECK IF directory exists
	if(!mkdir(USERPATH,0777)) { echo "Error creating ".USERPATH."\n" ; exit() ; 
		} else { echo "Directory: ".USERPATH." created\n" ; }
	} else { echo "Directory exists, let's continue\n" ; }
if(!is_dir(PATHINFO)) { 
	if(!mkdir(PATHINFO,0777)) { echo "Error creating ".PATHINFO."\n" ; exit() ; 
		} else { echo "Subirectory: ".PATHINFO." created\n" ; }
	} else { echo "Subdirectory exists too, let's continue\n" ; }
